  ...
  return (
    <>
      <button 
        ...
        className="px-4 py-2 bg-warning text-white rounded-lg text-sm font-medium hover:bg-orange-700 transition shadow-sm flex items-center gap-2"
      >
          ...
          <div className="bg-surface-card rounded-xl shadow-xl w-full max-w-lg max-h-[90vh] overflow-hidden flex flex-col">
            <div className="p-5 border-b border-border flex justify-between items-center bg-page/50">
              <h2 className="text-xl font-bold text-text-primary flex items-center gap-2">
                <span className="text-warning">🔥</span> Lệnh Nấu Bếp
              </h2>
            ...
            <div className="p-6 overflow-y-auto">
              <form id="productionForm" onSubmit={handleSubmit} className="space-y-5">
                ...
                {selectedSpId && (
                  <>
                    <div className="bg-warning/10 border border-orange-100 rounded-xl p-4">
                      ...
                      <div className="flex items-center gap-3 mt-3">
                        <input
                          ...
                          className="w-32 border border-border rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-orange-500 text-center font-black text-xl text-warning"
                        />
            ...
            <div className="p-5 border-t border-border bg-page flex justify-end gap-3 mt-auto">
              ...
              <button 
                ...
                className="px-5 py-2.5 bg-warning text-white font-bold rounded-lg hover:bg-orange-700 disabled:opacity-50 transition shadow-sm flex items-center gap-2"
              >
