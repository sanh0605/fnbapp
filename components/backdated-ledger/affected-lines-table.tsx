      ...
      <table className="min-w-full divide-y divide-border text-sm">
        ...
        <tbody className="divide-y divide-border bg-surface-card">
          {lines.map((line) => {
            ...
            const deltaColor = delta > 0 ? "text-success" : delta < 0 ? "text-danger" : "text-text-secondary";
        ...
        <tfoot className="bg-page font-medium">
          <tr>
            ...
            <td className={`px-4 py-3 text-right ${totalDelta > 0 ? "text-success" : totalDelta < 0 ? "text-danger" : "text-text-primary"}`}>
