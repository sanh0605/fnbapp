        ...
        {items.map((item, idx) => (
          <div key={item.id} className="flex flex-col md:flex-row gap-3 items-end bg-gray-50 p-4 rounded-lg border border-gray-200">
            ...
            <div className="w-full md:w-24">
              <label className="block text-xs font-bold text-gray-600 uppercase mb-1">Đơn vị</label>
              {item.isCustom ? (
                <input 
                  type="text" 
                  value={item.unit} 
            ...
            <div className="w-full md:w-32">
              <label className="block text-xs font-bold text-gray-600 uppercase mb-1">Đơn giá vốn</label>
            ...
            <div className="w-full md:w-24">
              <label className="block text-xs font-bold text-gray-600 uppercase mb-1">Định lượng</label>
              <input 
                type="number" 
                min="0"
                step="any"
