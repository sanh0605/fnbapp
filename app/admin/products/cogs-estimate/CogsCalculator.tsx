    ...
    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 max-w-4xl mx-auto">
            ...
            <div key={item.id} className="flex flex-col md:flex-row gap-3 items-end bg-gray-50 p-4 rounded-lg border border-gray-200">
              <div className="w-full md:w-1/3">
                ...
                {item.isCustom ? (
                  <input 
                    ...
                    className="w-full border border-gray-300 rounded-md px-3 py-2 min-h-[44px] text-sm focus:ring-orange-500"
                  />
                ) : (
                  <select 
                    id={`${itemRowId}-ingredient`}
              ...
              <div className="w-full md:w-24">
                ...
                {item.isCustom ? (
                  ...
                  <div className="w-full border border-gray-200 bg-gray-100 rounded-md px-3 py-2 min-h-[44px] flex items-center text-sm text-gray-500 font-medium">
                    {item.unit || "-"}
                  </div>
                )}
              </div>
              ...
              <div className="w-full md:w-32">
                ...
                <div className="relative">
                    <input 
                      ...
                      placeholder="0"
                      className={`w-full border border-gray-300 rounded-md px-3 py-2 min-h-[44px] text-sm font-bold focus:ring-orange-500 ${!item.isCustom ? "bg-gray-100 text-gray-500" : "text-indigo-700"}`}
                    />
                </div>
              </div>
              ...
              <div className="w-full md:w-24">
                ...
                <input 
                  ...
                  className="w-full border border-gray-300 rounded-md px-3 py-2 min-h-[44px] text-sm font-bold text-rose-600 focus:ring-orange-500"
                />
              </div>

              <div className="w-full md:w-32">
                <label className="block text-xs font-bold text-gray-600 uppercase mb-1">Thành tiền</label>
                <div className="w-full border border-transparent bg-orange-50 rounded-md px-3 py-2 min-h-[44px] flex items-center justify-end text-sm font-bold text-orange-700 text-right">
              ...
              <button 
                ...
                className="px-3 py-2 min-h-[44px] text-gray-400 hover:bg-rose-100 hover:text-rose-600 rounded-md transition-colors"
                title="Xoá dòng"
              >
      ...
      <div className="flex flex-wrap gap-3 mb-8">
        ...
        <button 
          ...
          className="flex items-center gap-2 px-4 py-2 min-h-[44px] bg-gray-100 text-gray-700 font-medium rounded-lg hover:bg-gray-200 transition-colors text-sm"
        >
