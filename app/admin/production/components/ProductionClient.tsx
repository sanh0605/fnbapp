        ...
        <>
          ...
          <div className="md:hidden flex flex-col gap-3">
            {sortedOrders.map(o => {
              ...
              return (
                <div key={o.id} className="bg-white rounded-xl border border-gray-100 p-4 shadow-sm flex flex-col gap-3">
                  <div className="flex justify-between items-start gap-2">
                    <div>
                      <h3 className="font-bold text-gray-900 leading-tight">
                        {sp?.name || o.semi_product_id}
                      </h3>
                      <div className="text-[10px] font-mono text-gray-400 mt-0.5">Mã: {o.id}</div>
                    </div>
                  ...
                  <div className="flex justify-between items-center pt-2">
                    <div>
                      <div className="text-[10px] uppercase tracking-wider font-bold text-gray-400 mb-1">Thu được</div>
                      <span className="inline-flex items-center px-2 py-0.5 rounded text-[11px] font-bold bg-blue-50 text-blue-700 border border-blue-100">
                        +{o.target_yield} {uName}
                      </span>
                    </div>
