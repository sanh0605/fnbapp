...
describe("Task 3.9 lock CLI safety shape", () => {
  ...
  it("verifies post-apply counts, unchanged costs, and the lock trigger", () => {
    expect(source).toContain("BACKDATED_HISTORICAL_GAP_FINAL_LOCK_COUNT");
