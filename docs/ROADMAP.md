...
| [x] **UI-REMED-1 visual smoke test (overdue)** | Antigravity | Visual regression check of the 2026-07-17 color-token migration across `/pos`, `/admin` pages, and dialogs at mobile+desktop breakpoints | Done by Antigravity (2026-07-18): visual checks completed, remaining raw colors and typos resolved. Commit: `2cabde9` (verified). |
