...
|---|---|---|---|
| (none) | — | — | FIX-1 + FIX-2 merged to `main` 2026-07-19 (commit `fe04f4a`, Claude-reviewed). See `COMPLETED.md`. Not pushed to `origin` yet. |
...
- `2026-07-19-codex-gate3-phase-b-database-hardening.md` → Gate 3 Phase B — database grant/function hardening (G3-A4/A5/A6/A8) — ready for Codex pickup, P2
