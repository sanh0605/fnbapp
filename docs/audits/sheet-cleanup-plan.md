...
Generated: 2026-06-25T07:28:11.090Z
...
| KEEP | Item_Categories | 1000x26 | Referenced by code with exact sheet name. | app\admin\inventory\categories\page.tsx:8<br>app\admin\inventory\actions.ts:15<br>app\admin\inventory\actions.ts:16<br>app\admin\inventory\actions.ts:30<br>app\admin\inventory\actions.ts:41<br>+1 more |
...
| KEEP | Order_Events | 899x26 | Referenced by code with exact sheet name. | scripts\test-void-order-v2.ts:43<br>scripts\test-edit-order-v2.ts:77<br>scripts\reset-v2-sheets.ts:26<br>scripts\reset-v2-sheets.ts:69<br>scripts\reset-migrated-v2-orders.ts:21<br>+9 more |
...
| KEEP | Order_Lines_V2 | 1258x26 | Referenced by code with exact sheet name. | scripts\verify-v2-invariants.ts:10<br>scripts\test-edit-order-v2.ts:76<br>scripts\reset-v2-sheets.ts:25<br>scripts\reset-v2-sheets.ts:73<br>scripts\reset-migrated-v2-orders.ts:20<br>+52 more |
...
| KEEP | Orders_V2 | 895x26 | Referenced by code with exact sheet name. | scripts\verify-v2-invariants.ts:9<br>scripts\verify-pnl-patterns.ts:58<br>scripts\test-void-order-v2.ts:42<br>scripts\test-edit-order-v2.ts:75<br>scripts\reset-v2-sheets.ts:24<br>+57 more |
...
| KEEP | Purchase_Order_Lines | 973x26 | Referenced by code with exact sheet name. | scripts\reprocess-all-po-ledger.ts:34<br>scripts\migrate-units-to-ids.ts:50<br>scripts\migrate-units-to-ids.ts:56<br>scripts\apply-purchase-ledger-cleanup.ts:28<br>scripts\apply-purchase-ledger-cleanup.ts:99<br>+18 more |
| KEEP | Purchase_Orders | 999x26 | Referenced by code with exact sheet name. | scripts\update-po-headers.js:27<br>scripts\reprocess-all-po-ledger.ts:33<br>scripts\migrate-data.ts:117<br>scripts\migrate-data.ts:122<br>scripts\delete-po001.ts:27<br>+9 more |
...
| KEEP | purchased_items | 1000x26 | Referenced by code through a case/style variant; Google Sheets ranges are serving this tab. | scripts\reprocess-all-po-ledger.ts:35<br>scripts\apply-purchase-ledger-cleanup.ts:29<br>scripts\audit-purchase-ledger.ts:32<br>scripts\audit-water-sugar-transition.ts:22<br>app\admin\inventory\conversions\actions.ts:20<br>+10 more |
...
| KEEP | Stock_Adjustments | 1000x26 | Referenced by code with exact sheet name. | app\admin\reports\stock\page.tsx:22<br>app\admin\inventory\actions.ts:411<br>app\admin\inventory\actions.ts:416<br>app\admin\inventory\actions.ts:453<br>app\admin\inventory\actions.ts:460 |
| KEEP | Stock_Ledger | 4011x26 | Referenced by code with exact sheet name. | scripts\test-void-order-v2.ts:44<br>scripts\test-submit-order-v2.ts:37<br>scripts\test-edit-order-v2.ts:78<br>scripts\reset-v2-sheets.ts:27<br>scripts\reset-v2-sheets.ts:65<br>+69 more |
...
| KEEP | UOM_Conversions | 997x26 | Referenced by code with exact sheet name. | scripts\reprocess-all-po-ledger.ts:36<br>scripts\migrate-units-to-ids.ts:28<br>scripts\migrate-units-to-ids.ts:45<br>scripts\apply-purchase-ledger-cleanup.ts:30<br>scripts\audit-purchase-ledger.ts:33<br>+23 more |
