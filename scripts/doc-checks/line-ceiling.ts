...
// The former single business-rules file was exempt until its Phase 3 by-domain
// split; now that docs/02-rules/business-rules/ exists, each domain file is
// ceiling-checked and the exemption is gone.
