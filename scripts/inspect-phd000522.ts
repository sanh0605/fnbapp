/**
 * Inspect PHD000522 V1 + V2 to design the fix.
 */
...
async function main() {
  ...
  // V1
  const v1 = (v1Orders as any[]).find(o => o.order_no === "PHD000522");
  console.log("=== V1 PHD000522 ===");
  console.log({
    id: v1?.id,
    ...
    applied_promotion_snapshot_json: v1?.applied_promotion_snapshot_json?.substring(0, 200),
  });
  ...
  for (const l of v1OrderLines) {
    console.log({
      ...
      modifiers_json: l.modifiers_json?.substring(0, 80),
    });
  }

  // V2
  const v2 = (v2Orders as any[]).find(o => o.order_no === "PHD000522");
  console.log("\n=== V2 PHD000522 ===");
  console.log({
    id: v2?.id,
  ...
  for (const l of v2OrderLines) {
    console.log({
      ...
      modifiers_snapshot_json: l.modifiers_snapshot_json?.substring(0, 80),
    });
  }
}
